"""
Two-phase orchestrator for the creepvale (Horror/Spooky) video pipeline,
adapted from pallowyn's main.py. Usage:
...
STATE_PATH = os.path.join(os.path.dirname(__file__), "..", "state", "creepvale_state.json")
...
HASHTAGS = "#horror #creepy #horrortiktok #scary #aiart"
CAPTION = ""  # silent-visual page, no captions, same as the other niches
...
def cmd_schedule():
    ...
    repo = os.environ.get("GITHUB_REPOSITORY", "workoutnow768-eng/creepvale")
    branch = "main"
